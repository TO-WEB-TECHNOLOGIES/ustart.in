...
<section className="el-elite-section" id="elite">
  <div className="el-elite-curve el-top">
    <svg viewBox="0 0 1440 100" preserveAspectRatio="none">
      <path d="M0,0 L0,25 C360,100 1080,100 1440,25 L1440,0 Z" fill="#ffffff"/>
    </svg>
  </div>
  ...
  <div className="wrap">
    ...
    <div className="witness-grid">
      <div className="witness-card reveal-tilt d1" style={{'--r': '-1.5deg'} as React.CSSProperties}>
        ...
        <p className="quote">"Honestly, I just wanted to order a late-night bite without getting hit by three separate 'convenience' surcharges at the final screen. <span className="hl">Paid ₹153 total, arrived on time, no games.</span>"</p>
      ...
      <div className="witness-card reveal-tilt d2" style={{'--r': '1.4deg'} as React.CSSProperties}>
        <div className="stars">★★★★★</div>
        <p className="quote">"Other apps were taking such a huge cut that we were basically working for them. Dropping commission down meant we could keep our staff paid without charging our customers ₹180 for a burger."</p>
